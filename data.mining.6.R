...
plot(Boston.test$medv, yhat.tree, xlab="Observed",ylab="Predicted", main="Regression",
     xlim=c(0,55), ylim=c(0,55))
abline(a=0, b=1, lty=2)

plot(Boston.test$medv, yhat.nn, xlab="Observed",ylab="Predicted", main="Regression",
      xlim=c(0,55), ylim=c(0,55))
abline(a=0, b=1, lty=2)

plot(Boston.test4medv, yhat.rf, xlab="Observed",ylab="Predicted", main="Regression",
     xlim=c(0,55), ylim=c(0,55))
abline(a=0, b=1, lty=2)
